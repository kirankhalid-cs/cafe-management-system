    ...
    Delete_Employee() {
        ...
        try {
            ...
            while (rest.next()) {
                ...
                y[i][2] = rest.getString("email");
                y[i][3] = rest.getString("age");
                y[i][4] = rest.getString("dob");
                y[i][5] = rest.getString("gender");
                i++;
            }
            t = new JTable(y, x);
        } catch (Exception ex) {
        ...
        if (arg.getSource() == bt1) {
            ...
            if (e_username.isEmpty()) {
                ...
                try {
                    ...
                    if (res == 1) {
                        JOptionPane.showMessageDialog(null, "Your data was successfully deleted");
                        this.setVisible(false);
                    } else {
                        JOptionPane.showMessageDialog(null, "Your data could not be successfully deleted");
